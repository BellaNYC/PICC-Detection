...
def init_args():
    ...
    parser.add_argument('--dataset_dir', default='G:/Study/lanenet/lanenet-lane-detection/data/train_data',
                        type=str, help='The source nsfw data dir path')
    parser.add_argument('--tfrecords_dir', default='../data/train_data/tfrecords',
                        type=str, help='The dir path to save converted tfrecords')
...
class LaneNetDataProducer(object):
    ...
    def __init__(self, dataset_dir):
        ...
        self._test_example_index_file_path = ops.join(self._dataset_dir, 'val.txt')
