...
class LaneNetBackEnd(cnn_basenet.CNNBaseModel):
    ...
    def compute_loss(self, binary_seg_logits, binary_label,
        ...
        with tf.variable_scope(name_or_scope=name, reuse=reuse):
            ...
            l2_reg_loss *= 0.001
            instance_segmentation_loss = binary_segmenatation_loss
    ...
    def inference(self, binary_seg_logits, instance_seg_logits, name, reuse, return_score=False):
        """
        ...
        with tf.variable_scope(name_or_scope=name, reuse=reuse):
            ...
            with tf.variable_scope(name_or_scope='binary_seg'):
                ...
                if return_score:
                    binary_seg_prediction = binary_seg_score
                else:
