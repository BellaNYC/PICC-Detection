...
def init_args():
    ...
    parser.add_argument('-d', '--dataset_dir', type=str, default='./data/train_data',
...
def train_lanenet(dataset_dir, weights_path=None, net_flag='vgg'):
    ...
    with tf.device('/gpu:1'):
        ...
        train_merge_summary_op = tf.summary.merge(
            [train_accuracy_scalar, train_binary_seg_loss_scalar, train_fn_scalar, train_fp_scalar]
        )
        ...
        val_merge_summary_op = tf.summary.merge(
            [val_accuracy_scalar, val_binary_seg_loss_scalar, val_fn_scalar, val_fp_scalar]
        )
    ...
    train_loss_list, train_accuracy_list, train_fn_list, train_fp_list = [], [], [], []
    val_loss_list, val_accuracy_list, val_fn_list, val_fp_list = [], [], [], []
